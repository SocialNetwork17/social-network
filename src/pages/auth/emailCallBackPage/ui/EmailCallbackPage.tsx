'use client'
import { useRegistrationConfirmation } from '@/pages/auth/emailCallBackPage/api/useRegistrationConfirmation'
import { useParams, useRouter, useSearchParams } from 'next/navigation'
import { useCheckRecoveryCode } from '@/pages/auth/emailCallBackPage/api/useCheckRecoveryCode'
import styles from '@/pages/auth/emailCallBackPage/ui/EmailCallbackPage.module.scss'
...
export const EmailCallbackPage = () => {
  ...
  const { mutate: registrationConfirm, isPending: isRegistrationLoad } =
