...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Универсальное модальное окно с поддержкой закрытия по клику на бэкдроп и клавише Escape.',
      },
    },
  },
  tags: ['autodocs'],
...
export const InteractiveExample = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Интерактивный пример">
        <div>
