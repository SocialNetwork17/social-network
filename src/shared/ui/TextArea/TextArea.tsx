...
export const TextArea = memo((props: Props) => {
    const {label, maxLength, error, errorText, disabled, placeholder, onChange, value} = props
    ...
    return (
        <div className={styles.textAreaContainer}>
            <label className={styles.label}>
                ...
                />
                <div className={styles.charCounter}>{internalValue.length}/{maxLength || 500}</div>
            </label>
