...
export interface components {
  schemas: {
    ...
    AvatarViewDto: {
      ...
      /**
       * Format: date-time
       * @example 2025-11-18T10:58:48.017Z
       */
      createdAt?: string
    }
    LastMessageViewDto: {
      ...
      /**
       * Format: date-time
       * @example 2025-11-18T10:58:48.888Z
       */
      createdAt: string
      /**
       * Format: date-time
    ...
    ValidationFieldError: {
      ...
      message:
        ...
        | 'The ban reason cannot be empty.'
        | 'Incorrect email'
        | 'dateOfBirth must be a valid Date format'
        | 'must be a number'
      /**
       * @example password
       * @example email
    ...
    FieldError: {
      ...
      message:
        ...
        | 'Authorization error'
        | 'Unauthorized'
        | 'Please complete your registration by confirming your email. Check your inbox and click on the confirmation link to proceed.'
        | 'Password must contain only Latin letters, numbers, and special characters.'
        | 'The ban reason cannot be empty.'
        | 'Incorrect email'
        | 'dateOfBirth must be a valid Date format'
        | 'must be a number'
        | 'The number of files is too large, please upload the file less than 10'
        | 'The file size is too large, please upload the file less than 20MB'
        | 'The file size is too large, please upload the file less than 10MB'
        | 'The file format is incorrect, please upload the correct file'
        | 'User not found'
        | 'Profile not found with profileId'
        | 'User with id: {} not found'
        | 'User not found with id {}'
        | 'Unsupported payment method: {}'
        | 'Invalid Stripe session response: missing required fields'
        | 'Stripe payment method failed: {}'
        | 'Invalid PayPal session response: missing required fields'
        | 'PayPal payment method failed: {}'
        | 'Stripe webhook error'
        | 'PayPal webhook error'
        | 'Authentication error'
        | 'Something went wrong'
        | 'No access rights'
        | 'receiverId must not be equal to userId'
        | 'Bad request'
    ...
    UpdateProfileInputDto: {
      ...
      /**
       * Format: date-time
       * @example 2025-11-18T10:58:48.093Z
       */
      dateOfBirth?: string
      /**
    ...
    PostViewModel: {
      ...
      /**
       * Format: date-time
       * @example 2025-11-18T10:58:48.375Z
       */
      createdAt: string
      /**
       * Format: date-time
...
export type SchemaRegistrationEmailResendingInputDto =
  components['schemas']['RegistrationEmailResendingInputDto']
...
export type SchemaUnauthorizedErrorResponseDto =
  components['schemas']['UnauthorizedErrorResponseDto']
...
export type SchemaPasswordRecoveryResendingInputDto =
  components['schemas']['PasswordRecoveryResendingInputDto']
export type SchemaPasswordRecoveryCodeInputDto =
  components['schemas']['PasswordRecoveryCodeInputDto']
...
export type SchemaGetAllUserSessionsResponseDto =
  components['schemas']['GetAllUserSessionsResponseDto']
...
export type SchemaResponseCountRegisteredUsers =
  components['schemas']['ResponseCountRegisteredUsers']
...
export type SchemaUserFollowingFollowersViewModel =
  components['schemas']['UserFollowingFollowersViewModel']
export type SchemaFollowingWithPaginationViewModel =
  components['schemas']['FollowingWithPaginationViewModel']
...
export type SchemaCurrentActiveSubscriptionsViewModel =
  components['schemas']['CurrentActiveSubscriptionsViewModel']
